    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 items-center sm:pt-0">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="col-md-12 mt-2">
                <div class="row text-lg text-gray-500 text-center tracking-wider">
                    Kontaktiere uns, wenn du Hilfe benötigst.
                </div>
                <div class="d-flex justify-center pt-8  sm:pt-3">
                    <div class="col-md-12 justify-center text-lg text-gray-500 text-center">
                        <div class="d-flex flex-column justify-center">
                            <div>
                                <span data-feather="instagram"></span>
                            </div>
                            <div>
                                <a href="https://www.instagram.com/campus_leben/" target="_blank">
                                    @campus_leben
                                </a>
                            </div>
                        </div>
